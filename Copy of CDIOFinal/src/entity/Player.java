...
public class Player {
	...
	public int getSpecificSerialChecker(int number) {return serialChecker[number];}
	public int getJailrounds() {return jailrounds;}
	public int[] getserialChecker() {return serialChecker;}
	...
	public void addSpecificSerialChecker(int number) {serialChecker[number]++;}
	public void addJailrounds() {this.jailrounds ++;}
	public void setailrounds(int jailrounds) {this.jailrounds = jailrounds;}
	public boolean isDoubleTurn() {return doubleTurn;}
	public void setDoubleTurn(boolean doubleTurn) {this.doubleTurn = doubleTurn;}
}
